...
export default function Home() {
  ...
  const {
    ...
    process,
    resetDetection,
  } = useCardDetection(cv, webcamRef, frameRef, config, () =>
    console.log("Card detected and stable! Autocaptured."),
  );
  ...
  const scaledPoints = useMemo(
    () => scalePoints(points, displayScale),
    [points, displayScale],
  );
  ...
  const scoreSatisfied = lastMetrics
    ? lastMetrics.score < config.qualityFloor
    : false;
  const confidenceSatisfied = lastMetrics
          ...
          <svg className="absolute inset-0 w-full h-full z-20 pointer-events-none">
            ...
            {scaledPoints.map((p, idx) => (
              <circle
                ...
                r="6"
                className={
                  state === "STABILIZING" ? "fill-sky-400" : "fill-emerald-400"
                }
              />
            ))}
          </svg>
          ...
          <div className="absolute top-0 right-0 h-full w-80 z-30 bg-neutral-900/95 backdrop-blur-md border-l border-white/10 p-6 flex flex-col gap-6 overflow-y-auto text-xs">
            ...
            <div className="flex flex-col gap-2.5 bg-black/40 border border-white/5 rounded-xl p-3.5 font-mono">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-semibold ${candidatesCount > 0 ? "text-emerald-400" : "text-amber-500"}`}
                >
                  {candidatesCount}
                </span>
              </div>
              {lastMetrics ? (
                <>
                  <div className="flex justify-between border-t border-white/5 pt-1.5 mt-1.5">
                    ...
                    <span
                      className={`font-semibold ${scoreSatisfied ? "text-emerald-400" : "text-rose-400"}`}
                    >
                  ...
                  <div className="flex justify-between text-[11px] pl-2 text-neutral-400">
                    ...
                    <span
                      className={
                        scoreSatisfied ? "text-emerald-400" : "text-rose-400"
                      }
                    >
                  ...
                  <div className="flex justify-between border-t border-white/5 pt-1.5 mt-1.5">
                    ...
                    <span
                      className={`font-semibold ${confidenceSatisfied ? "text-emerald-400" : "text-rose-400"}`}
                    >
                  ...
                  <div className="flex justify-between text-[11px] pl-2 text-neutral-400">
                    ...
                    <span>
                      {Math.abs(
                        lastMetrics.ratio - config.targetAspectRatio,
                      ).toFixed(3)}
                    </span>
                  </div>
                </>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between text-neutral-300">
                  ...
                  <span className="font-mono">
                    {(config.minAreaRatio * 100).toFixed(0)}%
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between text-neutral-300">
                  ...
                  <span className="font-mono">
                    {config.targetAspectRatio.toFixed(2)}
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between text-neutral-300">
                  ...
                  <span className="font-mono">
                    {config.aspectRatioTolerance.toFixed(2)}
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between text-neutral-300">
                  ...
                  <span className="font-mono">
                    {config.confidenceGap.toFixed(2)}
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateConfigValue("weightEdge", parseFloat(e.target.value))
                  }
                  className="w-full accent-emerald-500"
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateConfigValue("weightRatio", parseFloat(e.target.value))
                  }
                  className="w-full accent-emerald-500"
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between text-neutral-300">
                  ...
                  <span className="font-mono text-amber-300">
                    {config.weightTexture.toFixed(2)}
                  </span>
                </div>
                <input
                  type="range"
